...
import pushVapidPublicKeyHandler from "./api/push/vapid-public-key.js";
import pushSubscribeHandler from "./api/push/subscribe.js";
import pushUnsubscribeHandler from "./api/push/unsubscribe.js";
...
app.all("/api/push/vapid-public-key", adapt(pushVapidPublicKeyHandler));
app.all("/api/push/subscribe", adapt(pushSubscribeHandler));
app.all("/api/push/unsubscribe", adapt(pushUnsubscribeHandler));
app.all("/api/push/test", adapt(pushTestHandler));
